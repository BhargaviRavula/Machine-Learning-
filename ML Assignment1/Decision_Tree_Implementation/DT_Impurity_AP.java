...
public class DT_Impurity_AP {
	...
	public static void main(String[] args) throws Exception {
		...
		ArrayList<ArrayList<Parameter>> trainingSet = parseCSV(args[2]);
		ArrayList<ArrayList<Parameter>> validationSet = parseCSV(args[3]);
		ArrayList<ArrayList<Parameter>> testSet = parseCSV(args[4]);
